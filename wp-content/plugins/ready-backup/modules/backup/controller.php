...
class backupControllerBup extends controllerBup {
	...
	public function createAction() {
        ...
        // We are need to check "warehouse" directory (usually: wp-content/upready)
        // If it does not exists - create it and check r/w permissions.
